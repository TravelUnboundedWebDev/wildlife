            ...
            <div className='container'>
                <div className='row'>
                    <div className='col-12'>
                        ...
                        <p className='mb-3'>TRAVELUNBOUNDED WORLD PRIVATE LIMITED may change this policy
                        ...
                        <ul>
                            ...
                            <li className='mb-3'>We may collect the following information:</li>
                            <li className='mb-3'>name and job title</li>
                            <li className='mb-3'>contact information including email address</li>
                            <li className='mb-3'>demographic information such as postcode, preferences and interests</li>
                            <li className='mb-3'>other information relevant to customer surveys and/or offers</li>
                            <li className='mb-3'>What we do with the information we gather</li>
                        </ul>
                        <p className='mb-3'>We require this information to understand your needs and provide you with a
                        better service, and in particular for the following reasons:</p>
                        <ul>
                            <li className='mb-3'>Internal record keeping.</li>
                            <li className='mb-3'>We may use the information to improve our products and services.</li>
                            <li className='mb-3'>We may periodically send promotional emails about new products, special
                            offers or other information which we think you may find interesting using the
                            email address which you have provided.</li>
                            <li className='mb-3'>From time to time, we may also use your information to contact you for
                        ...
                        <p className='mb-3'>We are committed to ensuring that your information is secure. In order to
                        ...
                        <p className='mb-3'>A cookie is a small file which asks permission to be placed on your
                        ...
                        <p className='mb-3'>We use traffic log cookies to identify which pages are being used. This helps
                        ...
                        <p className='mb-3'>You can choose to accept or decline cookies. Most web browsers
                        ...
                        <p className='mb-3'>You may choose to restrict the collection or use of your personal information
                        in the following ways:</p>
                        <p className='mb-3'>whenever you are asked to fill in a form on the website, look for the box that
                        you can click to indicate that you do not want the information to be used by
                        anybody for direct marketing purposes</p>
                        <p className='mb-3'>if you have previously agreed to us using your personal information for direct
                        marketing purposes, you may change your mind at any time by writing to or
                        emailing us at support@travelunbounded.com</p>
                        <p className='mb-3'>We will not sell, distribute or lease your personal information to third parties
                        ...
                        <p className='mb-3'>The information contained in this website is for general information purposes
                        only and while we endeavor to keep the information up to date and correct,
                        ...
                        <p className='mb-3'>In no event will we be liable for any loss or damage including without
                        ...
                        <p className='mb-3'>Through this website you are able to link to other websites which are not
                        under the control of this business. We have no control over the nature,
                        ...
                        them.</p>
                        <p className='mb-3'>Every effort is made to keep the website up and running smoothly. However,
                        we takes no responsibility for, and will not be liable for, the website being
                        temporarily unavailable due to technical issues beyond our control.</p>
                        <p className='mb-5'>Cancellation &amp; Refund Policy: Cancellation and Refund policy depends on the
                        hotels and resorts where the reservation has been made, and it varies from
                        hotel to a hotel, tour to tour and factors such as the seasonality, duration
                        between the date of cancellation and the check in date, etc.</p>
                    </div>
                </div>
            </div>
        </div>
