...
function Home() {
    return ( 
        ...
        <img src = 'https://res.cloudinary.com/dl3vc69uw/image/upload/v1704693695/Destination_Kenya_kx8qmj_d4ceo8.jpg'
        alt = 'Kenya'
        ...
        <div className = 'des-container' >
        <div className = 'left' >
        <img src = 'https://res.cloudinary.com/dl3vc69uw/image/upload/v1704693912/Destination_Tanzania_oxwmkb_hpqsma.jpg'
        alt = 'Tanzania'
        className = 'wildlife-img' />
        </div>
        <div className = 'right' >
        ...
        <div className = 'left' >
        <div className = 'right d-md-none' >
        <img src = 'https://res.cloudinary.com/dl3vc69uw/image/upload/v1704693978/Destination_RTR_xuilod_sbubrr.jpg'
        alt = 'Ranthambore'
        className = 'wildlife-img' />
        </div>
        ...
        <div className = 'des-container' >
        <div className = 'left' >
        <img src = 'https://res.cloudinary.com/dl3vc69uw/image/upload/v1704694019/Destination_Bandhavgarh_k5gmc8_gdhlnq.jpg'
        alt = 'Bandhavgarh'
        className = 'wildlife-img' />
        </div>
        <div className = 'right' >
        ...
        <div className = 'left' >
        <div className = 'right d-md-none' >
        <img src = 'https://res.cloudinary.com/dl3vc69uw/image/upload/v1704694042/Destination_Corbett_gazwxq_c2jedb.jpg'
        alt = 'Corbett'
        className = 'wildlife-img' />
        </div>
        ...
        <div className = 'des-container' >
        <div className = 'left' >
        <img src = 'https://res.cloudinary.com/dl3vc69uw/image/upload/v1704694085/Tiger_Bandipur_lpnloe_elugbx.jpg'
        alt = 'Bandipur'
        className = 'wildlife-img' />
        </div>
        <div className = 'right' >
        ...
        <div className = 'left' >
        <div className = 'right d-md-none' >
        <img src = 'https://res.cloudinary.com/dl3vc69uw/image/upload/v1704694122/Mom_n_me_Kabini_obupgt_ysgb1t.jpg'
        alt = 'kabini'
        className = 'wildlife-img' />
        </div>
