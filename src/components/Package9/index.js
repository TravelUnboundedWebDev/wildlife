  ...
  return (
    ...
    <Navbar/>
      <div className='container mt-5'>
        <div className='row'>
          ...
          <div className='col-12 col-md-6 col-xl-6 col-lg-6'>
              <img src='https://res.cloudinary.com/dl3vc69uw/image/upload/v1706079379/wildebeests_oena5w.jpg' alt='corbett' className='package-image'/>
          </div>
        </div>
      </div>
      <div className='container mt-5'>
        <div className='row'>
          ...
          <div className='col-12 col-md-6 col-xl-6 col-lg-6'>
             <img src='https://res.cloudinary.com/dl3vc69uw/image/upload/v1706080330/Male_Lion_eaba00.jpg' alt='parwali in swimming' className='package-image-history' />
          </div>
      ...
      <div className='container mt-5'>
        <div className='row'>
          <div className='col-12 col-md-6 col-xl-6 col-lg-6'>
              <img src='https://res.cloudinary.com/dl3vc69uw/image/upload/v1706080343/Jaws_of_death_vmwnxh.jpg' alt='cubs in the pool' className='package-image-history-two'/>
          </div>
        ...
        <div className='row'>
          ...
          <hr/>
          <div className='col-12 col-md-6 col-xl-6 col-lg-6 main-head-left mb-3'>
              <p className='list-style'>14th August</p>
              ...
              <p className='list-style'>15th August</p>
              <p className='list-style'>Mara Keekorok Lodge – Standard</p>
              <p className='list-style'>Unlimited game drives. All meals and overnight at the hotel on FB</p>

              <p className='list-style'>16th August</p>
              <p className='list-style'>Mara Keekorok Lodge – Standard</p>
              <p className='list-style'>Unlimited game drives. All meals and overnight at the hotel on FB</p>

              <p className='list-style'>17th August</p>
              <p className='list-style'>Mara Keekorok Lodge – Standard</p>
              <p className='list-style'>Unlimited game drives. All meals and overnight at the hotel on FB</p>

              <p className='list-style'>18th August</p>
        ...
        <div className='row'>
          <div className='col-12 col-md-6 col-xl-6 col-lg-6 main-head-right'>
             <img src='https://res.cloudinary.com/dl3vc69uw/image/upload/v1704695449/eagle_ebdlcp_t3xchz.jpg' alt='' className='package-image-2' /> 
             <img src='https://res.cloudinary.com/dprd7eitr/image/upload/v1706082532/Hunt_hnbvrh.jpg' alt='' className='package-image-2' /> 
          </div>
          <div className='col-12 col-md-6 col-xl-6 col-lg-6'>
              <img src='https://res.cloudinary.com/dprd7eitr/image/upload/v1706082544/Giraffe_7J6A6579-Edit_vbjk18.jpg' alt='' className='package-image-last-2'/>
          </div>
          </div>
        </div>
        ...
        <div className='row'>
          <div className='col-12 col-md-6 col-xl-6 col-lg-6'>
              <img src='https://res.cloudinary.com/dprd7eitr/image/upload/v1706083240/keekorok-lodge_153107523417_glflea.jpg' alt='cubs in the pool' className='package-image-history-1'/>
          </div>
          <div className='col-12 col-md-6 col-xl-6 col-lg-6 main-head-right'>
        ...
        <div className='row'>
          ...
          <div className='col-12 col-md-6 col-xl-6 col-lg-6'>
              <img src='https://res.cloudinary.com/dprd7eitr/image/upload/v1706083249/LC_i0huzm.jpg' alt='cubs in the pool' className='package-image-history-two'/>
          </div>
          </div>
        </div>
        ...
        <hr/>
          <div className='col-12 col-md-6 col-xl-6 col-lg-6 main-head-right'>
              ...
              <div className='col-12 col-md-6 col-xl-6 col-lg-6 main-head-right'>
              <img src='https://res.cloudinary.com/dprd7eitr/image/upload/v1706089732/Sun_Downers_2_ovwiqd.jpg' alt='' className='package-image' />
          </div>
          </div>
        </div>
        <div className='container mt-5'>
        <div className='row'>
          <div className='col-12 col-md-6 col-xl-6 col-lg-6 main-head-right'>
              <img src='https://res.cloudinary.com/dprd7eitr/image/upload/v1706090166/TU_team_Mara_Nov_2017_selzih.jpg' alt='' className='package-image-3'/>
              </div>
              <div className='col-12 col-md-6 col-xl-6 col-lg-6 main-head-right'>
              <img src='https://res.cloudinary.com/dprd7eitr/image/upload/v1706090156/ID_J6A8233_rxnnwq.jpg' alt='' className='package-image-3' />
          </div>
          </div>
        </div>
        <div className='container mt-5'>
        ...
        <img src='https://res.cloudinary.com/dprd7eitr/image/upload/v1706090112/Mara_2017_vf4nt6.jpg' alt='' className='package-image-3'/>
        </div>
        </div>
        </div>
        <div className='container mt-5'>
        <div className='row'>
          <div className='col-12 col-md-6 col-xl-6 col-lg-6 main-head-right'>
              <img src='https://res.cloudinary.com/dprd7eitr/image/upload/v1706090130/Nov_18_frgcwt.jpg' alt='' className='package-image-3'/>
              </div>
              <div className='col-12 col-md-6 col-xl-6 col-lg-6 main-head-right'>
              <img src='https://res.cloudinary.com/dprd7eitr/image/upload/v1706090122/Mara_Nov_18_inasep.jpg' alt='' className='package-image-3' />
          </div>
          </div>
        </div>
